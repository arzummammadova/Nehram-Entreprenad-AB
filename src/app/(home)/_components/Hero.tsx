  ...
  return (
    <div className="text-center overflow-hidden">
      ...
      <motion.div
        ...
        className="relative w-full h-[300px] sm:h-[400px] md:h-[600px] lg:h-[700px] xl:h-[800px]"
      >
        <Image
      ...
      {/* --- 1-ci Bölmə --- */}
      <motion.div
        className="w-full lg:w-[60%] mx-auto py-[100px] flex flex-col gap-8 items-center"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeUp}
      >
        <h3 className='text-[#555555] text-[28px] font-bold'>
        ...
        <Link href="/kontakt">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className='bg-[#D1D1D1] text-white w-[169px] py-3 px-2 text-[18px] uppercase font-medium tracking-wider hover:bg-[#D1D1D4] duration-300'
          >
            Kontact oss
          </motion.button>
        </Link>
      ...
      {/* --- 3-cü Bölmə məzmun --- */}
      <motion.div
        className="lg:w-[60%] w-full mx-auto py-[100px] flex flex-col gap-8 items-center"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeUp}
      >
        ...
        <Link href="/kontakt">
          <motion.button
            whileHover={{ scale: 1.08 }}
            whileTap={{ scale: 0.95 }}
            className='bg-[#FF8C62] rounded-4xl text-white w-[250px] py-3 px-1 text-[18px] uppercase font-medium tracking-wider duration-300 button-contact'
          >
            Kontact oss
          </motion.button>
        </Link>
